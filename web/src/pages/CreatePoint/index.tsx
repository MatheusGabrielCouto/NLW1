    ...
    <div id="page-create-point">
      ...
      <fieldset>
        ...
        <Map center={initialPosition} zoom={15} onClick={handleMapClick}>
          <TileLayer url={`https://api.mapbox.com/styles/v1/mapbox/light-v10/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1IjoibWF0aGV1c2dhYnJpZWwxNTciLCJhIjoiY2tnYWQ4NWNtMDFuZjJ4cW9rcmh1YjNwbCJ9.ThYXIuIDTmqPw4iLGM92rA`} />
